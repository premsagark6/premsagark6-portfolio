...
const SKILLS = [
  ...
  { name: "GoDaddy", logo: "/dist/Godaddy.png" },
  { name: "Hostinger", logo: "dist/hostinger.png" },
  { name: "SEO", logo: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/google/google-original.svg" },
];

const ROWS = [
  [
    { title: "Frontend Development", items: ["HTML", "CSS", "JavaScript", "React", "Tailwind CSS"] },
    { title: "Backend Development", items: ["NodeJS", "Express", "PHP", "Spring Boot"] },
    { title: "Databases", items: ["MongoDB", "MySQL"] },
    { title: "Tools & Platforms", items: ["Git", "WordPress", "GoDaddy", "Hostinger", "SEO"] },
  ],
  [
    {
    ...
    },
    {
      ...
      items: ["Custom Web Development", "WordPress Theme Customization", "Backend Systems", "Cloud Hosting Deployments", "SEO Optimization"],
    },
  ],
];
